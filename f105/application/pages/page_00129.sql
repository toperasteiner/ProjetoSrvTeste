...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(53140636700549854398)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(71009909750105692)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(53140636700549854398)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(71010316504105693)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8473334130539126)
,p_name=>'P129_DATA'
,p_source_data_type=>'TIMESTAMP'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_imp.id(53140636700549854398)
,p_item_source_plug_id=>wwv_flow_imp.id(53140636700549854398)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14539915913723033)
,p_name=>'P129_EMAILS'
,p_item_sequence=>10
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14540272214723036)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71010782119105693)
,p_name=>'P129_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71011165524105693)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71012016011105694)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71012430920105694)
,p_name=>'P129_TITULO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71013376861105695)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(8473262827539125)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8474226013539135)
...
,p_associated_item=>wwv_flow_imp.id(71012430920105694)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8474316021539136)
...
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(71013376861105695)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(71017729174105701)
,p_name=>'CANCEL-Click'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(71010316504105693)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(71018264374105701)
,p_event_id=>wwv_flow_imp.id(71017729174105701)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(14540028089723034)
,p_name=>'New'
,p_event_sequence=>60
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(14540158731723035)
,p_event_id=>wwv_flow_imp.id(14540028089723034)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(71016557551105700)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(53140636700549854398)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8473561573539128)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14540321276723037)
...
,p_attribute_10=>'Y'
,p_attribute_11=>wwv_flow_imp.id(16675073020706426)
,p_attribute_12=>'{"ID_CHAMADO":"&P129_ID_CHAMADO.","USUARIO_NOME":"&P129_NOME_USUARIO.","TITULO":"&P129_TITULO.","DESCRICAO":"&P129_DESCRICAO."}'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(71009909750105692)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(71016177526105700)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(71015722264105697)
,p_process_sequence=>10
