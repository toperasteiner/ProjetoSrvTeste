...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16873612329948431)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16874487228948439)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_imp.id(16873612329948431)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(23747114950141337)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16874589523948440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16873803923948433)
,p_name=>'P171_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16873612329948431)
,p_item_source_plug_id=>wwv_flow_imp.id(16873612329948431)
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16873903394948434)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16874058001948435)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16874147487948436)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16874200604948437)
,p_name=>'P171_DATA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16874308994948438)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16875093548948445)
,p_name=>'P171_MINUTOS'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(16873612329948431)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16875184729948446)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23743712105141303)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23744107747141307)
,p_name=>'P171_HORAS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(16873612329948431)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(23743884390141304)
...
,p_associated_item=>wwv_flow_imp.id(16874308994948438)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(23743926522141305)
...
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_validation_condition_type=>'NEVER'
,p_associated_item=>wwv_flow_imp.id(16875093548948445)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(23745877437141324)
...
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(16874147487948436)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(23745905171141325)
,p_validation_name=>'Valida data'
,p_validation_sequence=>70
,p_validation=>'RETURN PKG_SUPORTE.VALID_APONTAMENTO_DATA(:P171_DATA, :P171_CURRENT_DATE);'
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(16874200604948437)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(23746019062141326)
,p_validation_name=>'Valida horas trabalhadas'
,p_validation_sequence=>80
,p_validation=>'RETURN PKG_SUPORTE.VALID_APONTAMENTO_HORAS(:P171_HORAS);'
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(23744107747141307)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16874640063948441)
,p_name=>'Cancelar'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(16874487228948439)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16874736306948442)
,p_event_id=>wwv_flow_imp.id(16874640063948441)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(16875402964948449)
,p_name=>'Seta horas'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16875504204948450)
,p_event_id=>wwv_flow_imp.id(16875402964948449)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16874849054948443)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(16873612329948431)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(22014363563256607)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16873765348948432)
,p_process_sequence=>10
