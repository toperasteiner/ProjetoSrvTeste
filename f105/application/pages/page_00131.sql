...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(53189360846224575574)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(71264532131342330)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(53189360846224575574)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(71264912783342330)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14540918713723043)
,p_name=>'P131_EMAILS'
,p_item_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14541252448723046)
,p_name=>'P131_NOME_USUARIO'
,p_item_sequence=>250
,p_item_plug_id=>wwv_flow_imp.id(53189360846224575574)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71265370428342330)
,p_name=>'P131_ID'
...
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(53189360846224575574)
,p_item_source_plug_id=>wwv_flow_imp.id(53189360846224575574)
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71265762680342331)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71266101105342331)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71266543190342331)
,p_name=>'P131_TITULO'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_imp.id(53189360846224575574)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71266903624342331)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71267360854342332)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71267716405342332)
,p_name=>'P131_ANEXO'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(53189360846224575574)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71268155557342332)
...
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(71266903624342331)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(71271472870342335)
,p_name=>'CANCEL-Click'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(71264912783342330)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(71271909743342335)
,p_event_id=>wwv_flow_imp.id(71271472870342335)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(14541091944723044)
,p_name=>'New'
,p_event_sequence=>60
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(14541168359723045)
,p_event_id=>wwv_flow_imp.id(14541091944723044)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(71270206472342334)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(71271035100342334)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(71270611575342334)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14541330403723047)
...
,p_attribute_10=>'N'
,p_attribute_11=>wwv_flow_imp.id(16681671779866790)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(71264532131342330)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(71269857838342334)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(71269479154342333)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(53189360846224575574)
