...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(80922275296651350)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80922582058651350)
,p_plug_template_id=>wwv_flow_imp.id(80922275296651350)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80922839962651350)
,p_plug_template_id=>wwv_flow_imp.id(80922275296651350)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80923140393651350)
,p_plug_template_id=>wwv_flow_imp.id(80922275296651350)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80923466469651350)
,p_plug_template_id=>wwv_flow_imp.id(80922275296651350)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80923804214651351)
,p_plug_template_id=>wwv_flow_imp.id(80922275296651350)
,p_name=>'Sub Regions'
