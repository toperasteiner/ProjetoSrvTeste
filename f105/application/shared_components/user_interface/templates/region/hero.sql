...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69747139043463875)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69747468394463876)
,p_plug_template_id=>wwv_flow_imp.id(69747139043463875)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69747798434463876)
,p_plug_template_id=>wwv_flow_imp.id(69747139043463875)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69748010683463876)
,p_plug_template_id=>wwv_flow_imp.id(69747139043463875)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69748329061463876)
,p_plug_template_id=>wwv_flow_imp.id(69747139043463875)
,p_name=>'Sub Regions'
