...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(80896973351651338)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80897316447651338)
,p_plug_template_id=>wwv_flow_imp.id(80896973351651338)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80897578734651338)
,p_plug_template_id=>wwv_flow_imp.id(80896973351651338)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80897870062651338)
,p_plug_template_id=>wwv_flow_imp.id(80896973351651338)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80898163615651338)
,p_plug_template_id=>wwv_flow_imp.id(80896973351651338)
,p_name=>'Sub Regions'
