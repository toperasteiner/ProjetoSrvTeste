...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69684246813463843)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69684596466463843)
,p_plug_template_id=>wwv_flow_imp.id(69684246813463843)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69684884375463844)
,p_plug_template_id=>wwv_flow_imp.id(69684246813463843)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69685189903463844)
,p_plug_template_id=>wwv_flow_imp.id(69684246813463843)
,p_name=>'Sub Regions'
