...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69754781277463879)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69755000844463880)
,p_plug_template_id=>wwv_flow_imp.id(69754781277463879)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69755377511463880)
,p_plug_template_id=>wwv_flow_imp.id(69754781277463879)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69755649450463880)
,p_plug_template_id=>wwv_flow_imp.id(69754781277463879)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69755979813463880)
,p_plug_template_id=>wwv_flow_imp.id(69754781277463879)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69756250002463880)
,p_plug_template_id=>wwv_flow_imp.id(69754781277463879)
,p_name=>'Sub Regions'
