...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69705847684463854)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69706127547463855)
,p_plug_template_id=>wwv_flow_imp.id(69705847684463854)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69706429922463855)
,p_plug_template_id=>wwv_flow_imp.id(69705847684463854)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69706794764463855)
,p_plug_template_id=>wwv_flow_imp.id(69705847684463854)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69707046811463855)
,p_plug_template_id=>wwv_flow_imp.id(69705847684463854)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69707375831463855)
,p_plug_template_id=>wwv_flow_imp.id(69705847684463854)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69707699033463856)
,p_plug_template_id=>wwv_flow_imp.id(69705847684463854)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69707961951463856)
,p_plug_template_id=>wwv_flow_imp.id(69705847684463854)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69708278313463856)
,p_plug_template_id=>wwv_flow_imp.id(69705847684463854)
,p_name=>'Sub Regions'
