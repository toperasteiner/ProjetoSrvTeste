...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(80900189801651339)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80900449816651339)
,p_plug_template_id=>wwv_flow_imp.id(80900189801651339)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80900743427651340)
,p_plug_template_id=>wwv_flow_imp.id(80900189801651339)
,p_name=>'Sub Regions'
