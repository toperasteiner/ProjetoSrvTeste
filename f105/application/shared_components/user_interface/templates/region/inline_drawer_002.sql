...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(80910186704651344)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80910521326651344)
,p_plug_template_id=>wwv_flow_imp.id(80910186704651344)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80910767734651344)
,p_plug_template_id=>wwv_flow_imp.id(80910186704651344)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80911092768651345)
,p_plug_template_id=>wwv_flow_imp.id(80910186704651344)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80911394252651345)
,p_plug_template_id=>wwv_flow_imp.id(80910186704651344)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80911681741651345)
,p_plug_template_id=>wwv_flow_imp.id(80910186704651344)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80912023713651345)
,p_plug_template_id=>wwv_flow_imp.id(80910186704651344)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80912308747651345)
,p_plug_template_id=>wwv_flow_imp.id(80910186704651344)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80912604717651345)
,p_plug_template_id=>wwv_flow_imp.id(80910186704651344)
,p_name=>'Sub Regions'
