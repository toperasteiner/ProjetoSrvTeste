...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(69868489140583415)
,p_lov_name=>'LV_SUP_NOTIFICACAO'
,p_lov_query=>'.'||wwv_flow_imp.id(69868489140583415)||'.'
,p_location=>'STATIC'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(69869246528583416)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(69868879408583416)
