...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69722766108463863)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69723066778463864)
,p_plug_template_id=>wwv_flow_imp.id(69722766108463863)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69723336480463864)
,p_plug_template_id=>wwv_flow_imp.id(69722766108463863)
,p_name=>'Tabs'
