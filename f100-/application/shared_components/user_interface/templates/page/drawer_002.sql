...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(80828530869651303)
,p_theme_id=>101
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80828829542651303)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80829119166651303)
,p_page_template_id=>wwv_flow_imp.id(80828530869651303)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80829385348651303)
,p_page_template_id=>wwv_flow_imp.id(80828530869651303)
