...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(80849116091651313)
,p_theme_id=>101
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80849426329651313)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80849717450651313)
,p_page_template_id=>wwv_flow_imp.id(80849116091651313)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(80850016383651313)
,p_page_template_id=>wwv_flow_imp.id(80849116091651313)
