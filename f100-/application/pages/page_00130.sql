...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(128842313573046605203)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(70983574004046777)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(128842313573046605203)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(70983950412046777)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(128842313573046605203)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14537210593723006)
,p_name=>'P130_USUARIO'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(128842313573046605203)
,p_item_source_plug_id=>wwv_flow_imp.id(128842313573046605203)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14539396002723027)
,p_name=>'P130_EMAILS'
,p_item_sequence=>10
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70984353480046777)
,p_name=>'P130_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70984794226046778)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70985175331046778)
,p_name=>'P130_NOME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(128842313573046605203)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70985504577046778)
,p_name=>'P130_ANEXO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70985902180046779)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70986389593046779)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8475320262539146)
,p_validation_name=>'Valida nome do anexo'
,p_validation_sequence=>10
,p_validation=>'RETURN PKG_SUPORTE.VALID_NOME_ANEXO(:P130_NOME);'
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(70985175331046778)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8475420914539147)
,p_validation_name=>'Valida anexo'
,p_validation_sequence=>20
,p_validation=>'RETURN PKG_SUPORTE.VALID_ANEXO(:P130_ANEXO);'
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(70985504577046778)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(70990525603046782)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(70983950412046777)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(70991072246046782)
,p_event_id=>wwv_flow_imp.id(70990525603046782)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(70991471727046782)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(70991996194046783)
,p_event_id=>wwv_flow_imp.id(70991471727046782)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(70992352940046783)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(70992847457046783)
,p_event_id=>wwv_flow_imp.id(70992352940046783)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(70993329624046784)
,p_event_id=>wwv_flow_imp.id(70992352940046783)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(14539672687723030)
,p_name=>'Load'
,p_event_sequence=>40
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(14539757641723031)
,p_event_id=>wwv_flow_imp.id(14539672687723030)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(70989325290046781)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14539800474723032)
...
,p_attribute_10=>'Y'
,p_attribute_11=>wwv_flow_imp.id(16672662802584503)
,p_attribute_12=>'{"ID_CHAMADO":"&P130_ID_CHAMADO.","USUARIO_NOME":"&P130_USUARIO.","TITULO":"&P130_NOME."}'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(70983574004046777)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(70988920141046781)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(70988524336046780)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(128842313573046605203)
