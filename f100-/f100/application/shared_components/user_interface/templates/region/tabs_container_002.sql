...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86322383548647883)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86322715742647883)
,p_plug_template_id=>wwv_flow_imp.id(86322383548647883)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86322980813647883)
,p_plug_template_id=>wwv_flow_imp.id(86322383548647883)
,p_name=>'Tabs'
