...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(75117919850460393)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75118217502460393)
,p_plug_template_id=>wwv_flow_imp.id(75117919850460393)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75118560048460393)
,p_plug_template_id=>wwv_flow_imp.id(75117919850460393)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75118791747460393)
,p_plug_template_id=>wwv_flow_imp.id(75117919850460393)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75119112070460393)
,p_plug_template_id=>wwv_flow_imp.id(75117919850460393)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75119430097460394)
,p_plug_template_id=>wwv_flow_imp.id(75117919850460393)
