...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(75142564040460405)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75142783607460406)
,p_plug_template_id=>wwv_flow_imp.id(75142564040460405)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75143160274460406)
,p_plug_template_id=>wwv_flow_imp.id(75142564040460405)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75143432213460406)
,p_plug_template_id=>wwv_flow_imp.id(75142564040460405)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75143762576460406)
,p_plug_template_id=>wwv_flow_imp.id(75142564040460405)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75144032765460406)
,p_plug_template_id=>wwv_flow_imp.id(75142564040460405)
,p_name=>'Sub Regions'
