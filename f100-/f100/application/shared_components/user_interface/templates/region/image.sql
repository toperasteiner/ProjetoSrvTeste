...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(75088279344460378)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75088559863460378)
,p_plug_template_id=>wwv_flow_imp.id(75088279344460378)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75088843300460378)
,p_plug_template_id=>wwv_flow_imp.id(75088279344460378)
,p_name=>'Sub Regions'
