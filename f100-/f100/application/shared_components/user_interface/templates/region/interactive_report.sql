...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(75098471144460383)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75098722160460383)
,p_plug_template_id=>wwv_flow_imp.id(75098471144460383)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75099031407460383)
,p_plug_template_id=>wwv_flow_imp.id(75098471144460383)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75099376838460384)
,p_plug_template_id=>wwv_flow_imp.id(75098471144460383)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75099619608460384)
,p_plug_template_id=>wwv_flow_imp.id(75098471144460383)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75099970754460384)
,p_plug_template_id=>wwv_flow_imp.id(75098471144460383)
,p_name=>'Sub Regions'
