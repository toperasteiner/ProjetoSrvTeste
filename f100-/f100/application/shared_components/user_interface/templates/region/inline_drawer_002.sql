...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86297969467647870)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86298304089647870)
,p_plug_template_id=>wwv_flow_imp.id(86297969467647870)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86298550497647870)
,p_plug_template_id=>wwv_flow_imp.id(86297969467647870)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86298875531647871)
,p_plug_template_id=>wwv_flow_imp.id(86297969467647870)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86299177015647871)
,p_plug_template_id=>wwv_flow_imp.id(86297969467647870)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86299464504647871)
,p_plug_template_id=>wwv_flow_imp.id(86297969467647870)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86299806476647871)
,p_plug_template_id=>wwv_flow_imp.id(86297969467647870)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86300091510647871)
,p_plug_template_id=>wwv_flow_imp.id(86297969467647870)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86300387480647871)
,p_plug_template_id=>wwv_flow_imp.id(86297969467647870)
,p_name=>'Sub Regions'
