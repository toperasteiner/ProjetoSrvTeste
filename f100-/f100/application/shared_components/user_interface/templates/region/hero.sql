...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(75134921806460401)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75135251157460402)
,p_plug_template_id=>wwv_flow_imp.id(75134921806460401)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75135581197460402)
,p_plug_template_id=>wwv_flow_imp.id(75134921806460401)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75135793446460402)
,p_plug_template_id=>wwv_flow_imp.id(75134921806460401)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75136111824460402)
,p_plug_template_id=>wwv_flow_imp.id(75134921806460401)
,p_name=>'Sub Regions'
