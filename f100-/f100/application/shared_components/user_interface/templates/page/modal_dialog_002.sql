...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(86236898854647839)
,p_theme_id=>101
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86237209092647839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86237500213647839)
,p_page_template_id=>wwv_flow_imp.id(86236898854647839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86237799146647839)
,p_page_template_id=>wwv_flow_imp.id(86236898854647839)
