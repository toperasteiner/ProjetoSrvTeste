...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(75028984232460332)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75029373103460339)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75029614624460339)
,p_page_template_id=>wwv_flow_imp.id(75028984232460332)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75029892009460339)
,p_page_template_id=>wwv_flow_imp.id(75028984232460332)
