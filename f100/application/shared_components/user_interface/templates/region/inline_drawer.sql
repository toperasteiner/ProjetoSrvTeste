...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(75093630447460380)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75093910310460381)
,p_plug_template_id=>wwv_flow_imp.id(75093630447460380)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75094212685460381)
,p_plug_template_id=>wwv_flow_imp.id(75093630447460380)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75094577527460381)
,p_plug_template_id=>wwv_flow_imp.id(75093630447460380)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75094829574460381)
,p_plug_template_id=>wwv_flow_imp.id(75093630447460380)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75095158594460381)
,p_plug_template_id=>wwv_flow_imp.id(75093630447460380)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75095481796460382)
,p_plug_template_id=>wwv_flow_imp.id(75093630447460380)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75095744714460382)
,p_plug_template_id=>wwv_flow_imp.id(75093630447460380)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75096061076460382)
,p_plug_template_id=>wwv_flow_imp.id(75093630447460380)
,p_name=>'Sub Regions'
