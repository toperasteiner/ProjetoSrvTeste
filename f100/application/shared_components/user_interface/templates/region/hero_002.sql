...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86284756114647864)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86285099210647864)
,p_plug_template_id=>wwv_flow_imp.id(86284756114647864)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86285361497647864)
,p_plug_template_id=>wwv_flow_imp.id(86284756114647864)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86285652825647864)
,p_plug_template_id=>wwv_flow_imp.id(86284756114647864)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86285946378647864)
,p_plug_template_id=>wwv_flow_imp.id(86284756114647864)
,p_name=>'Sub Regions'
