...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(75083995003460376)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75084317364460376)
,p_plug_template_id=>wwv_flow_imp.id(75083995003460376)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75084666796460376)
,p_plug_template_id=>wwv_flow_imp.id(75083995003460376)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75084958776460376)
,p_plug_template_id=>wwv_flow_imp.id(75083995003460376)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75085215218460377)
,p_plug_template_id=>wwv_flow_imp.id(75083995003460376)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75085546005460377)
,p_plug_template_id=>wwv_flow_imp.id(75083995003460376)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75085844926460377)
,p_plug_template_id=>wwv_flow_imp.id(75083995003460376)
,p_name=>'Sub Regions'
