...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(75110548871460389)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75110849541460390)
,p_plug_template_id=>wwv_flow_imp.id(75110548871460389)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(75111119243460390)
,p_plug_template_id=>wwv_flow_imp.id(75110548871460389)
,p_name=>'Tabs'
