...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86287972564647865)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86288232579647865)
,p_plug_template_id=>wwv_flow_imp.id(86287972564647865)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86288526190647866)
,p_plug_template_id=>wwv_flow_imp.id(86287972564647865)
,p_name=>'Sub Regions'
