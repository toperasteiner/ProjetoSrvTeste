...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86259277573647850)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86259528823647850)
,p_plug_template_id=>wwv_flow_imp.id(86259277573647850)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86259916862647850)
,p_plug_template_id=>wwv_flow_imp.id(86259277573647850)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86260216437647850)
,p_plug_template_id=>wwv_flow_imp.id(86259277573647850)
,p_name=>'Sub Regions'
