...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(86310058059647876)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86310364821647876)
,p_plug_template_id=>wwv_flow_imp.id(86310058059647876)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86310622725647876)
,p_plug_template_id=>wwv_flow_imp.id(86310058059647876)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86310923156647876)
,p_plug_template_id=>wwv_flow_imp.id(86310058059647876)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86311249232647876)
,p_plug_template_id=>wwv_flow_imp.id(86310058059647876)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(86311586977647877)
,p_plug_template_id=>wwv_flow_imp.id(86310058059647876)
,p_name=>'Sub Regions'
