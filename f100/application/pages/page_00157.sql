...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(128853073711710273849)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(76409559577114954)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(128853073711710273849)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(76409974142114954)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(128853073711710273849)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19928254098719564)
,p_name=>'P157_EMAILS'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_imp.id(128853073711710273849)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19928663274719568)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76410342177114954)
,p_name=>'P157_ID'
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(128853073711710273849)
,p_item_source_plug_id=>wwv_flow_imp.id(128853073711710273849)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76410774459114955)
,p_name=>'P157_STATUS'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(76413304433114957)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(76409974142114954)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76413855505114957)
,p_event_id=>wwv_flow_imp.id(76413304433114957)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(19928378733719565)
,p_name=>'New'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(19928417388719566)
,p_event_id=>wwv_flow_imp.id(19928378733719565)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76412933146114956)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76412112698114956)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(19928539006719567)
...
,p_attribute_10=>'Y'
,p_attribute_11=>wwv_flow_imp.id(22065856747802614)
,p_attribute_12=>'{"ID_CHAMADO":"&P157_ID.","USUARIO_NOME":"&P157_NOME_USUARIO."}'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(76409559577114954)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76412536220114956)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76411723458114955)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(128853073711710273849)
