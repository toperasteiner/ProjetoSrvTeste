...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(128896266828615150460)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(75509660888933042)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(128896266828615150460)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(75510057631933042)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(128896266828615150460)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(19925439508719536)
,p_name=>'P164_USUARIO'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(128896266828615150460)
,p_item_source_plug_id=>wwv_flow_imp.id(128896266828615150460)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75510400600933043)
,p_name=>'P164_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75510871180933043)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75511265299933043)
,p_name=>'P164_NOME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(128896266828615150460)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75511623570933044)
,p_name=>'P164_ANEXO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75512040088933044)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75512385306933044)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(19924754083719529)
,p_validation_name=>'Valida nome do anexo'
,p_validation_sequence=>10
,p_validation=>'RETURN PKG_SUPORTE.VALID_NOME_ANEXO(:P164_NOME);'
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(75511265299933043)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(19924855874719530)
,p_validation_name=>'Valida anexo'
,p_validation_sequence=>20
,p_validation=>'RETURN PKG_SUPORTE.VALID_ANEXO(:P164_ANEXO);'
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(75511623570933044)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(75515824313933046)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(75510057631933042)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(75516342167933047)
,p_event_id=>wwv_flow_imp.id(75515824313933046)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(75516693922933047)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(75517231344933047)
,p_event_id=>wwv_flow_imp.id(75516693922933047)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(75517642366933048)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(75518161408933048)
,p_event_id=>wwv_flow_imp.id(75517642366933048)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(75518643052933048)
,p_event_id=>wwv_flow_imp.id(75517642366933048)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75515441040933046)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75515041501933046)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75514632230933046)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(128896266828615150460)
