...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(53260171443404768159)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(75532542517954890)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(53260171443404768159)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(75532956030954890)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75533315587954891)
,p_name=>'P111_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_is_query_only=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(53260171443404768159)
,p_item_source_plug_id=>wwv_flow_imp.id(53260171443404768159)
,p_source=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75533763220954891)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75534161287954891)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75534553803954892)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75534942681954892)
,p_name=>'P111_NOME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(53260171443404768159)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75535802406954893)
,p_name=>'P111_EMAIL'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_imp.id(53260171443404768159)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(13862598812535667)
,p_validation_name=>'Valida nome externo'
,p_validation_sequence=>10
,p_validation=>'RETURN PKG_SUPORTE.VALID_NOME_EXTERNO(:P111_NOME);'
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(75534942681954892)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(13862722758535668)
,p_validation_name=>'Valida e-mail externo'
,p_validation_sequence=>20
,p_validation=>'RETURN PKG_SUPORTE.VALID_EMAIL_EXTERNO(:P111_EMAIL);'
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_associated_item=>wwv_flow_imp.id(75535802406954893)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(75539739234954895)
,p_name=>'CANCEL-Click'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(75532956030954890)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(75540193551954895)
,p_event_id=>wwv_flow_imp.id(75539739234954895)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75538978359954895)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(53260171443404768159)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75539320927954895)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75538550117954894)
,p_process_sequence=>10
